      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="space-y-4">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 dark:text-gray-500 text-sm">Sign in with your account</p>
                </div>
              </div>
          ...
          <button
            ...
            className="w-full group relative overflow-hidden p-6 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-3xl shadow-soft dark:shadow-none hover:shadow-xl dark:hover:bg-gray-750 transition-all duration-300 text-left"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-red-50 to-transparent dark:from-red-900/10 opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 dark:text-gray-500 text-sm">Sign in with your staff account</p>
                </div>
              </div>
